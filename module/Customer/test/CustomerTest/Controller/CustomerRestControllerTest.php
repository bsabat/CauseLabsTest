<?php
namespace CustomerRestTest\Controller;

use CustomerRestTest\Bootstrap;
use Customer\Controller\CustomerRestController;
...
class CustomerRestControllerTest extends PHPUnit_Framework_TestCase
{
